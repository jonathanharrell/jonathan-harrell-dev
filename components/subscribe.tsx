        ...
        <form action={formAction} className="flex flex-wrap items-center gap-6">
          <div className="flex gap-2 max-sm:flex-1">
            ...
            <button
              type="submit"
              disabled={pending}
              className="px-3 bg-accent disabled:brightness-[50%] hover:brightness-[90%] hover:dark:brightness-[80%] text-lg text-neutral-900 transition-all duration-200 ease-in-out"
            >
              Subscribe
            </button>
          </div>
