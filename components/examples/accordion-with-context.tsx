...
class AccordionItem extends React.Component<AccordionItemProps, AccordionItemState> {
  ...
  return (
    <AccordionItemContext.Consumer>
      {({expanded, toggleExpansion}) => (
        <h2>
          <button onClick={toggleExpansion} className="w-full py-3 px-4 text-left">
            {expanded ? "▼ " : "► "}
            {props.children}
          </button>
        </h2>
...
const AccordionPanel = (props: AccordionPanelProps) => {
  return (
    <AccordionItemContext.Consumer>
      {({expanded}) => <div className={"p-4 border-t border-neutral-700 " + (expanded ? "block" : "hidden")}>{props.children}</div>}
    </AccordionItemContext.Consumer>
  );
};
          ...
          <div className="not-article-body p-12 sm:px-16 bg-neutral-100 dark:bg-neutral-950 font-sans text-base">
            <Accordion>
              ...
              <AccordionItem>
                ...
                <AccordionPanel>
                  Sed non urna. Donec et ante. Phasellus eu ligula. Vestibulum sit amet purus. Vivamus hendrerit, dolor
                  at
              ...
              <AccordionItem>
                ...
                <AccordionPanel>
                  Nam enim risus, molestie et, porta ac, aliquam ac, risus. Quisque lobortis. Phasellus pellentesque
                  purus in
                  massa. Aenean in pede. Phasellus ac libero ac tellus pellentesque semper. Sed ac felis. Sed commodo,
                  magna
