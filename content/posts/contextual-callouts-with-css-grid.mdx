...
![This image shows a webpage layout structured using a CSS grid. Red gridlines divide the page into rows and columns. On the left, there's text that represents callouts, aligned to specific grid sections. In the center, text flows across multiple columns, while a grey rectangle in the middle represents an image placeholder. The overall design demonstrates how CSS grid can be used to position text and images within a structured grid system.](/assets/css-grid-layout-1.svg)
...
<aside>
  <p>This is a special aside positioning thing that goes onto multiple lines</p>
</aside>
...
![Image here](/assets/css-grid-layout-2.svg "This is a caption")
...
<aside className="warning">
  Warning about absolute positioning
</aside>
...
![Image here](/assets/css-grid-layout-3.svg "This is a caption")
...
<aside className="demo">
  Check out the [live experiment](/experiments/css-grid-callouts/) to see this in action.
</aside>