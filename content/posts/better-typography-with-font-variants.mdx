...
thumbnail: /assets/thumbnails/font-variants.svg
description: >-
...
![Image here](/assets/common-ligatures.svg "Common ligatures often include character pairings where the first letter is “f”.")
...
![Image here](/assets/discretionary-ligatures.svg "Discretionary ligatures can include character pairings with flourished connections.")
...
![Image here](/assets/contextual-ligatures.svg "In the Inkwell Script typeface, alternate versions of the letters “f” and “t” are automatically introduced.")
...
![Image here](/assets/historical-ligatures.svg "Alternate characters like the archaic “long s” can be used in historical settings.")
...
![Image here](/assets/subscript.svg "True subscript characters are sized and positioned specifically for use in footnotes and scientific formulas.")
...
![Image here](/assets/superscript.svg "True superscript characters are sized and positioned specifically for use in mathematical expressions and scientific formulas.")
...
![Image here](/assets/small-caps.svg "Small caps in the typeface Hoefler Text match the x-height of the font.")
...
![Image here](/assets/all-small-caps.svg "All characters in the typeface Hoefler Text are converted to small caps using all-small-caps.")
...
![Image here](/assets/petite-caps.svg "Petite caps in the typeface EB Garamond are slightly shorter than the x-height of the font.")
...
![Image here](/assets/all-petite-caps.svg "All characters in the typeface EB Garamond are converted to petite caps using all-petite-caps.")
...
![Image here](/assets/unicase.svg "A version of the Arial typeface includes unicase characters.")
...
![Image here](/assets/titling-caps.svg "Titling caps are designed for headline sizes, as seen here with the Hoefler Titling typeface.")
...
![Image here](/assets/lining-nums.svg "Lining numerals in the typeface Ideal Sans stretch from baseline to cap-height.")
...
![Image here](/assets/oldstyle-nums.svg "Old-style numerals in the typeface Ideal Sans ascend and descend to sympathize with the rhythm of lowercase letters.")
...
![Image here.](/assets/proportional-nums.svg "Proportional numerals should be used in contexts where the vertical alignment of numbers is not important.")
...
![Image here.](/assets/tabular-nums.svg "Tabular numerals should be used in contexts where numbers need to be stacked.")
...
![Image here.](/assets/diagonal-fractions.svg "Numerators and denominators in the typeface Ideal Sans are aligned with the baseline and cap-height.")
...
![Image here.](/assets/stacked-fractions.svg "Numerators and denominators are horizontally aligned in stacked fraction alternates.")
...
![Image here.](/assets/ordinals.svg "The typeface Fedra Sans includes specially sized and positioned characters for common ordinals like “1st”, “2nd”, and “3rd”.")
...
![Image here.](/assets/slashed-zero.svg "The typeface Operator Mono includes a special slashed-zero numeral.")
...
![Image here.](/assets/historical-forms.svg "The typeface Hoefler Text provides an historical alternate “s” character, known as the archaic “long s”.")
...
![Image here.](/assets/stylistic.svg "The typeface Ideal Sans includes several special characters and alernates, such as the Inscriptional “G”.")
...
![Image here.](/assets/styleset.svg "Stylesets in the typeface Hoefler Text allow you to apply related alternate characters.")
...
![Image here.](/assets/character-variant.svg "The italic style of the typeface Hoefler Text includes variants for several characters, including the letters “k” and “z”.")
...
![Image here.](/assets/swash.svg "The typeface Hoefler Text includes alternate italic swash caps for several characters, including “M”.")
...
![Image here.](/assets/ornaments.svg "The typeface Hoefler Text provides many graphic characters, including several fleurons.")
...
![Image here.](/assets/annotations.svg "The collection of Whitney Index fonts provides examples of annotation characters.")
