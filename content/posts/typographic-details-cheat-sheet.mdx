...
<p className="text-base text-neutral-400"><span className="small-caps">NOTE</span>: You can use the above characters directly in your code without needing to use an HTML entity. If you are using a Mac, open your symbol viewer and pop in the correct character.</p>
