...
| Name | Entity | When to use | Example |
| -------- | ------- | ------- | ------- |
| Hyphen | - | Use a hyphen for one of the following: - joining words to indicate they have a combined meaning - indicating missing words shared by a series of compounds - indicating stuttering speech - splitting words when breaking them across lines | She wore a well-tailored jacket. |
