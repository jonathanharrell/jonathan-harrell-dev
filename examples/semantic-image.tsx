export const SemanticImageExample = () => {
  return (
    <figure>
      <div className="flex items-center justify-center p-12 sm:p-16 bg-neutral-100 dark:bg-neutral-925">
        <article className="not-article-prose group w-full overflow-hidden rounded-xl border border-neutral-200 dark:border-neutral-900 hover:border-accent hover:bg-accent transition-colors">
          <figure className="relative">
            <img
              ...
              className="object-cover group-hover:mix-blend-multiply group-hover:filter group-hover:blur-sm transition-all"
            />
