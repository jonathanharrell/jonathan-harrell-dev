  ...
  return (
    <AccordionItemContext.Consumer>
      {({ expanded }) => (
        <div
          className={
            "p-4 border-t border-neutral-300 dark:border-neutral-700 " +
...
export class AccordionExample extends React.Component {
  render() {
    return (
      <figure>
        <div>
          <div className="not-article-prose p-8 sm:py-12 sm:px-16 bg-neutral-100 dark:bg-neutral-925 font-sans text-base">
            <Accordion>
              <AccordionItem>
